...
const peminjamanTicketModel = require('../models/peminjamanTicketModel')
const pengajuanbeliTicketModel = require('../models/pengajuanbeliTicketModel')
...
const delete_ticket = async (req, res) => {
    ...
    switch (ticket.jenis_ticket) {
        ...
        case "Pengajuan Pembelian":
            pengajuanbeliTicketModel.findByIdAndDelete(ticket.id_ticket_detail)
                .catch(err => console.log(err))
            break;
        ...
        case "Peminjaman Ruangan/Tempat":
            peminjamanTicketModel.findByIdAndDelete(ticket.id_ticket_detail)
                .catch(err => console.log(err))
            break;
        case "Konsumsi":
...
// TODO PRINT TICKET UNTUK PEMINJAMAN DAN PEMBELIAN
...
const get_data = async (req, res) => {
    ...
    const pengajuanbeli_ticket = await pengajuanbeliTicketModel.find().count()
    const expecourmail_ticket = await expecourmailTicketModel.find().count()
    const peminjaman_ticket = await peminjamanTicketModel.find().count()
    ...
    const type_data = [atk_ticket, consum_ticket, expecourmail_ticket, pengajuanbeli_ticket, peminjaman_ticket, konsumsi_ticket, rtk_ticket, workfurn_ticket]
